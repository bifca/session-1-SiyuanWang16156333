...
<div class="navigation">
 <div class="logo">
  <a href="index.php"><img src="images/7.jpg"></a>
 </div>
...
require 'var.php';
   ...
   $sql = "SELECT picture,name,introduction FROM `red` WHERE pictureID = $id";
   ...
   if (mysqli_num_rows($result) > 0) {
       while($row = mysqli_fetch_assoc($result)) {
         ...
         echo "</div>";
         echo '<br/>';
         echo '<div class="text">'.$row["introduction"].'</div>';//Selects the information from the title bar i.e. Portfolio.php?id=1 or ?id=100. This will make the varable $id = to the value id=
      };
   } else {
       echo "0 results";
   }
